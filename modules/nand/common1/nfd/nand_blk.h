...
extern int panic_read(const char *part_name, uint32 start_sector,
		uint32 sector_num, uchar *buf);
extern int panic_write(const char *part_name, uint32 start_sector,
		uint32 sector_num, uchar *buf);
extern int panic_init_part(const char *name, unsigned int off, int num,
